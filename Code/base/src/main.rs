    ...
    loop {
        {
            ...
            let mut breath_runner = Runner::new(breath, drawer, Some(Duration::from_secs_f64(1.0/2.0)), Duration::from_secs(32));
...

        {
            ...
            let rainbow = Rainbow::new(Duration::from_secs_f64(5.0), 0.75, 0.75, 1.5, 16*8);
            let mut rainbow_runner = Runner::new(rainbow, drawer, Some(Duration::from_secs_f64(1.0/2.0)), Duration::from_secs(32));
